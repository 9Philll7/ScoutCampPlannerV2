        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnergyKilojoules = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    FatGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    SaturatedFatGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    CarbohydrateGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    SugarsGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    ProteinGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    SaltGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    FiberGrams = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_IngredientRevisionNutritionProfiles_ReferenceQuantity_Posit~", "\"ReferenceQuantity\" > 0");
                    ...
                    table.ForeignKey(
                        name: "FK_IngredientRevisionNutritionProfiles_IngredientRevisions_Ing~",
                    ...
                    table.ForeignKey(
                        name: "FK_IngredientRevisionNutritionProfiles_MeasurementUnits_Refere~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_IngredientVariantNutritionProfiles_ReferenceQuantity_Positi~", "\"ReferenceQuantity\" > 0");
                    ...
                    table.ForeignKey(
                        name: "FK_IngredientVariantNutritionProfiles_IngredientVariantRevisio~",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientVariantNutritionProfiles_MeasurementUnits_Referen~",
                        column: x => x.ReferenceUnitId,
                        principalSchema: "catering",
                        principalTable: "MeasurementUnits",
                        principalColumn: "Id",
