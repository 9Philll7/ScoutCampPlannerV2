...
namespace ScoutCampPlanner.Migrations.PostgreSql.Platform
{
    ...
    [Migration("20260920211125_AddLocalDeviceCampAccess")]
    partial class AddLocalDeviceCampAccess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScoutCampPlanner.Platform.Domain.CampRoleAssignment", b =>
                {
                    ...
                    b.ToTable("CampRoleAssignments", "platform");
                });
            ...
            modelBuilder.Entity("ScoutCampPlanner.Platform.Domain.LocalDeviceIdentity", b =>
                {
                    ...
                    b.ToTable("LocalDeviceIdentities", "platform");
                });
            ...
            modelBuilder.Entity("ScoutCampPlanner.Platform.Domain.PlatformRoleAssignment", b =>
                {
                    ...
                    b.ToTable("PlatformRoleAssignments", "platform");
                });
