...
- productive shared business/audit transaction coordination, checkpoint advancement, verification, and use-case integration; the Platform-owned contract, EF migrations, active-key loading, canonical HMAC encoding, journal initialization, and standalone append transaction are present for PostgreSQL and SQLite
